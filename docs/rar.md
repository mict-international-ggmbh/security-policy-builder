...
Security and compliance is everyone's responsibility.  MiCT is committed to
...
managers and executives at MiCT.
...
oversight of all activities pertaining to MiCT's efforts to be compliant
...
MiCT has appointed Adam Burns as the Security
Officer and Maren Hornung as the Privacy Officer.
...
workforce members are required to:
  ...
  * Follow all security requirements set forth in MiCT security
...
(c) All workforce members are required to report non-compliance of MiCT's
...
the select members of the senior leadership team, including Security Officer, Privacy Officer, CTO, COO,
in addition to the Security and Privacy Officer.

#### General Responsibilities of the Security and Privacy Officer

The authority and accountability for MiCT’s information
...
workforce members and any other user of MiCT's systems, applications,
...
3. Take all reasonable steps to hire, retain, and promote workforce members and
   ...
   MiCT's security policies and procedures.

#### Segregation of Duties

MiCT has dedicated team/personnel assigned the job
...
3. The training session focuses on, but is not limited to, the following
   subjects defined in MiCT's security policies and procedures:

    1. SOC 2 Security Principals and Controls;
    1. Risk Management procedures and documentation;
    1. Auditing. MiCT may monitor access and activities of all users;
    1. Workstations may only be used to perform assigned job responsibilities;
    1. Users may not download software onto MiCT's workstations
    ...
    of MiCT's systems and/or workstations;
    ...
    do so by a MiCT Partner;
    1. Users are required to understand their role in MiCT's contingency
    plan;
...
MiCT leverages KnowBe4 to deliver innovative, fun and
...
MiCT holds a company-wide roundtable at least quarterly to
