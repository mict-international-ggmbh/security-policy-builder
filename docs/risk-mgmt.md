...
This policy establishes the scope, objectives, and procedures of MiCT's
...
(b) Risk assessments must be performed with any major change to MiCT's
...
MiCT has established formal risk analysis and risk management
processes to
...
MiCT's corporate compliance and information security program.
...
Risk assessments are done throughout product life cycles:
  ...
  * Before the integration of new system technologies and before changes are
    made to MiCT physical and technical safeguards; and (Note that these
    ...
    new Partners, or new code developed for operations and management of the
    MiCT Platform)
  * While making changes to MiCT physical equipment and facilities that
    introduce new, untested configurations.

MiCT performs periodic technical and non-technical assessments of the
...
MiCT implements security measures sufficient to reduce risks and
vulnerabilities to a reasonable and appropriate level to:
  ...
  1. Ensure the confidentiality, integrity, and availability of all sensitive data
     MiCT receives, maintains, processes, and/or transmits for its
     Partners;
  2. Protect against any reasonably anticipated threats or hazards to the
     security or integrity of Partners data and/or sensitive data;
  3. Protect against any reasonably anticipated uses or disclosures of Partners
     data and/or sensitive data that are not permitted or required; and
  4. Ensure compliance by all workforce members.

In addition, MiCT risk management process requires that:

1. Any risk remaining (residual) after other risk controls have been applied,
   requires sign off by the senior management and MiCT's Security Officer.
2. All MiCT workforce members are expected to fully cooperate with all
   ...
   outlined in the MiCT Roles Policy.
3. The implementation, execution, and maintenance of the information security
   risk analysis and risk management process is the responsibility of MiCT's
...
ensure the continued adequacy and continuous improvement of MiCT's
information security program:

* Scheduled Basis - an overall risk assessment of MiCT's information system
...
* Step 1. System Characterization
    ...
    * The first step in assessing risk is to define the scope of the effort. To
      ...
      transmitted. Using information-gathering techniques, the MiCT Platform
      boundaries are identified.

    * Output - Characterization of the MiCT Platform system assessed, a good
...
* Step 4. Control Analysis
    ...
    * Document and assess the effectiveness of technical and non-technical
      controls that have been or will be implemented by MiCT to minimize or
...
* Step 6. Impact Analysis
    ...
    * Determine the level of adverse impact that would result from a threat
      ...
      to consider should include the importance to MiCT's mission;
...
to ensure the confidentiality, integrity and availability of MiCT Platform
...
* Step 4. Select Control(s)
    ...
    * Taking into account the information and results from previous steps,
      MiCT's mission, and other important criteria, the Risk Management Team
...
* Step 6. Develop Safeguard Implementation Plan
    ...
    * The overall implementation plan provides a broad overview of the safeguard
      ...
      indicators should be reported to MiCT Senior Management.
...
MiCT Security team maintains a registry of risks, captured and kept updated
...
MiCT holds cyber liability insurance with sufficient coverage
...
MiCT considers its fraud-related risk to be very low.

MiCT hires  to perform accounting services and
