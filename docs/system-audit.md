...
MiCT shall audit, monitor, and assess the access and activity of
...
capabilities and resources. MiCT shall make reasonable and
...
It is the policy of MiCT to safeguard the confidentiality, integrity, and
availability of applications, systems, and networks. To ensure that appropriate
safeguards are in place and effective, MiCT shall audit access and activity
...
This policy applies to all MiCT systems that store, transmit, or process
...
(c) An annual audit of MiCT security controls must be conducted, either by a
...
2. **Access Review:** This refers to the review of all user and service accounts
   and permissions across MiCT operational environments, including
   on-premise systems, cloud environments such as Google accounts, and other
...
3. **Compliance and Controls Audit:** This refers to the audit performed against
   ...
   MiCT policies and procedures, to measure their adoption and
   ...
   intervals* or prompted by a *trigger event*.
    ...
    !!! tip "Potential trigger events include:"
        ...
        * Business associate or partner complaints
...
* Responsibility for audit activity is assigned to MiCT's Security Officer.
  The Security Officer shall:
    ...
    * All connections to MiCT are monitored. Access is limited to certain
...
1. A request may be made for an audit for a specific cause. The request may come
   ...
   Security Officer, Partner, or an Application owner or application
   user.

2. A request for an audit for specific cause must include time frame, frequency,
   and nature of the request.

3. A request for an audit must be reviewed and approved by MiCT's Privacy
    ...
    * Should the audit disclose that a workforce member has accessed sensitive data
      ...
      be shared with MiCT's Security Officer to determine appropriate
      sanction/corrective disciplinary action.
    * Only de-identified information shall be shared with Partners
      regarding the results of the investigative audit process. This information
      will be communicated to the appropriate personnel by MiCT's Privacy
      Officer or designee. Prior to communicating with partners
      regarding an audit, it is recommended that MiCT consider seeking
...
2. The reporting process shall allow for meaningful communication of the audit
   findings to relevant workforce members or Partners.

    * Significant findings shall be reported immediately in a written format.
      MiCT's security incident response form may be utilized to report a
      single event.
...
4. Security audits constitute an internal, confidential monitoring practice that
   may be included in MiCT's performance improvement activities and
...
5. Whenever indicated through evaluation and reporting, appropriate corrective
   ...
   the responsible workforce members, and/or Partners.
...
MiCT logging standards requires application and system logs to contain
...
All systems and software developed at MiCT must have the following security
...
3. Whenever possible, audit logs shall be stored on a separate system to
    ...
    * MiCT logging servers may include Elasticsearch, Logstash, and Kibana
...
1. Periodic monitoring of Partner activity shall be carried out to
   ensure that access and activity is appropriate for privileges granted and
   necessary to the arrangement between MiCT and the 3rd party.
   MiCT will make every effort to assure Partners
   do not gain access to data outside of their own environments.

1. If it is determined that the Partner has exceeded the scope of
   access privileges, MiCT's management and security must remedy
   the problem immediately.


### Auditing and Assessment Tools

MiCT's Security Officer is authorized to select and use assessment tools
that are designed to detect vulnerabilities and intrusions. Use of such tools
against MiCT systems and environments are prohibited by others, including
Partners, without the explicit authorization of the Security
...
1. MiCT workforce members are provided training, education, and
   awareness on safeguarding the privacy and security of business and data.
   MiCT's commitment to auditing access and activity of the
   ...
   applicable policies. MiCT workforce members are made aware of
...
2. MiCT Partners are provided with necessary information to understand
   MiCT auditing capabilities. Platform Partners are responsible for the
   logging, auditing and retention of any application hosted outside of MiCT
   environments, even though the applications may integrate with MiCT
   Platform API.  Partner applications hosted within the MiCT environments
