...
MiCT is committed to ensuring all workforce members actively address
security and compliance in their roles at MiCT. We encourage self management
...
MiCT policy requires all workforce members to comply with the
...
the environments, systems, security requirements, and procedures MiCT has in
...
MiCT systems has been removed, as well as ensuring that all company owned
assets are returned.

(e) MiCT and its employees will take reasonable measures to
ensure no sensitive data is transmitted via digital communications such as email
or posted on social media outlets.

(f) MiCT will maintain a list of prohibited activities that will be part of
...
business contracts, etc. MiCT reserves the right to terminate employees in
...
MiCT uses internal resources to manage its workforce personnel records.
...
MiCT requires all workforce members to comply with the following
...
(b) Use of MiCT computing systems is subject to monitoring by
...
(k) Mobile devices are not allowed to connect directly to MiCT production
environments.


### Employee Screening Procedures

MiCT publishes job descriptions for available positions and
...
[MiCT's internal file sharing site](#).

The HR Representative / Facility Manager is responsible to initiate and track the
onboarding process. The onboarding process should include the following
IT/Security items:

1. Training.

    * New workforce member is provided training on MiCT security policy,
...
2. Access.
    ...
    * Standard access is provisioned according to the job role and approval.
    * Non-standard access requires additional approval following the access
      request procedures.
    * Request for modifications of access for any MiCT employee
...
3. Security will terminate users' access rights immediately upon notification,
   and will coordinate with the appropriate MiCT employees to terminate
...
MiCT workforce members are to escalate issues using the
...
MiCT's incident response procedures; if you are unsure whether
...
The MiCT requires all workforce members to observe high
...
to report serious concerns so that MiCT can address and correct
...
MiCT encourages employees to go above and beyond to contribute
to the business objectives and help their peers and partners. Employees are
...
MiCT provides employees the opportunity to attend conferences,
...
Workforce members shall report non-compliance of MiCT's policies and
...
1. The Security Officer promptly facilitates a thorough investigation of all
   reported violations of MiCT's security policies and procedures. The
    ...
    * Provide individuals suspected of non-compliance of the Security rule
      and/or MiCT's policies and procedures the opportunity to explain their
      actions.
...
2. Violation of any security policy or procedure by workforce members may result
   ...
   business associates and partners may result in termination of the
    ...
    * MiCT reserves the right to terminate employees in the case of serious
      cases of misconduct.
    * A violation resulting in a breach of confidentiality (i.e. release of
      ...
      termination of the workforce member from MiCT.
...
4. In the case of an insider threat, the Security Officer and Privacy Officer
   ...
   malicious activity. MiCT workforce members are encouraged to come forward
