...
!!! check "Acknowledgement"
    ...
    * I have completed the required [Security awareness training][4].
    * I understand that partner data and sensitive data may only be stored in approved production environments.
...
* **Ongoing security awareness** training
  (a regular series, currently provided by MiCT)
